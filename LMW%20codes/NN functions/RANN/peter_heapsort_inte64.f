...
c
c
        subroutine peter_heapsort_inte(ra,ia,n)
        implicit none
        INTEGER *8 n,ia(n),ra(1),i,ii,ii0,m,jj,lone
c
c        This subroutine uses the standard heapsort scheme to
c        sort an integer array ra. The sort is returned in the 
...
c
        ii0=ii/2
        call peter_heapit_inte(ra,ia,n,ii0)
 1600 continue
c
c       . . . sort
c
...
c
        m=m-1
        lone = 1
        call peter_heapit_inte(ra,ia,m,lone)
 2000 continue
c
        return
        end
...
c
c
        subroutine peter_heapit_inte(ra,ia,n,ii)
        implicit none
        INTEGER *8 n,ia(n),ra(1),ii,ijk,ison1,ison2,j0,j1,j2,i
c
c       heapify
c
        i=ii
